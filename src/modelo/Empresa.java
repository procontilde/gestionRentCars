...
public class Empresa {
    ...
    public boolean eliminarVehiculo(String matricula) {
        ...
        if(vehiculo != null) {
            ...
            this.misVehiculos.remove(vehiculo);
            return true;
    ...
    public boolean eliminarEmpleado(String dni) {
        ...
        Empleado empleado = encontrarEmpleado(dni);
    ...
    public Empleado encontrarEmpleado(String dni) {
        ...
        for (Empleado empleado : misEmpleados) if (empleado.getDni().equals(dni)) return empleado;
        return null;
